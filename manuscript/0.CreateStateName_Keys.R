...
for (l in 1:length(countries)){
  ...
  ## ----------------------- Create initial merge key data frame ----------------------------------
  ...
  # Assign country code to variable names so I can keep each object (useful for manually adding alternative spellings)
...
# Refer to the unmatched_states output and KEY.merge_ascii to manually check the correct code for unmatched states.
...
# Must list GID_1 codes in correct order when adding to unmatched states... 
