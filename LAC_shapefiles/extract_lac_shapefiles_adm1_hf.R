...
# Load shapefiles
lac_shapefile <- read_sf("manuscript/data/ShapeFiles_2/America_Adm_1/adm1_amro_lat_long.shp")

# create folder for processed data
dir.create("manuscript/data/ShapeFiles_2/America_Adm_1/processed")
...
for(i in 1:length(countries)){
  ...
  file_path = paste0("manuscript/data/ShapeFiles_2/America_Adm_1/processed/", gsub(" ", "_", countries[i]))
  ifelse(!dir.exists(file.path(file_path)), dir.create(file.path(file_path)), FALSE)

  # Set filename based on country
  file_name = paste0(gsub(" ", "_", countries[i]), "_ADM1.shp")
...
ecuador_shp = lac_shapefile <- read_sf("manuscript/data/ShapeFiles_2/America_Adm_1/processed/Ecuador/Ecuador_ADM2.shp")
plot(ecuador_shp$geometry)

# Load and view Nicaragua
nicaragua_shp = lac_shapefile <- read_sf("manuscript/data/ShapeFiles_2/America_Adm_1/processed/Nicaragua/Nicaragua_ADM2.shp")
